...
from models.depthwise_conv2d import DepthwiseConv2D
...
def build_model(image_size,
    ...
    # Build the network.
    ############################################################################
    model= mobilenet.MobileNet(weights='imagenet', include_top=False, input_shape=(img_height, img_width, img_channels))
    print(model.summary())
    ...
    # alpha=1
    # conv1 = Conv2D(int(32 * alpha), (3, 3), strides=(2, 2), padding='same', use_bias=False)(x1)
    # conv1 = BatchNormalization()(conv1)
    # conv1 = Activation('relu')(conv1)
    #
    # conv2 = DepthwiseConv2D(int(32 * alpha), (3, 3), strides=(1, 1), padding='same', use_bias=False)(conv1)
    # conv2 = BatchNormalization()(conv2)
    # conv2 = Activation('relu')(conv2)
    # conv2 = Conv2D(int(64 * alpha), (1, 1), strides=(1, 1), padding='same', use_bias=False)(conv2)
    # conv2 = BatchNormalization()(conv2)
    # conv2 = Activation('relu')(conv2)
    #
    # conv3 = DepthwiseConv2D(int(64 * alpha), (3, 3), strides=(2, 2), padding='same', use_bias=False)(conv2)
    # conv3 = BatchNormalization()(conv3)
    # conv3 = Activation('relu')(conv3)
    # conv3 = Conv2D(int(128 * alpha), (1, 1), strides=(1, 1), padding='same', use_bias=False)(conv3)
    # conv3 = BatchNormalization()(conv3)
    # conv3 = Activation('relu')(conv3)
    #
    # conv4 = DepthwiseConv2D(int(128 * alpha), (3, 3), strides=(1, 1), padding='same', use_bias=False)(conv3)
    # conv4 = BatchNormalization()(conv4)
    # conv4 = Activation('relu')(conv4)
    # conv4 = Conv2D(int(128 * alpha), (1, 1), strides=(1, 1), padding='same', use_bias=False)(conv4)
    # conv4 = BatchNormalization()(conv4)
    # conv4 = Activation('relu')(conv4)
    #
    # conv5 = DepthwiseConv2D(int(128 * alpha), (3, 3), strides=(2, 2), padding='same', use_bias=False)(conv4)
    # conv5 = BatchNormalization()(conv5)
    # conv5 = Activation('relu')(conv5)
    # conv5 = Conv2D(int(256 * alpha), (1, 1), strides=(1, 1), padding='same', use_bias=False)(conv5)
    # conv5 = BatchNormalization()(conv5)
    # conv5 = Activation('relu')(conv5)
    #
    # conv6 = DepthwiseConv2D(int(256 * alpha), (3, 3), strides=(1, 1), padding='same', use_bias=False)(conv5)
    # conv6 = BatchNormalization()(conv6)
    # conv6 = Activation('relu')(conv6)
    # conv6 = Conv2D(int(256 * alpha), (1, 1), strides=(1, 1), padding='same', use_bias=False)(conv6)
    # conv6 = BatchNormalization()(conv6)
    # conv6 = Activation('relu')(conv6)
    #
    # conv7 = DepthwiseConv2D(int(256 * alpha), (3, 3), strides=(2, 2), padding='same', use_bias=False)(conv6)
    # conv7 = BatchNormalization()(conv7)
    # conv7 = Activation('relu')(conv7)
    # conv7 = Conv2D(int(512 * alpha), (1, 1), strides=(1, 1), padding='same', use_bias=False)(conv7)
    # conv7 = BatchNormalization()(conv7)
    # conv7 = Activation('relu')(conv7)
    #
    # # if not shallow:
    # for _ in range(4):
    #     conv8 = DepthwiseConv2D(int(512 * alpha), (3, 3), strides=(1, 1), padding='same', use_bias=False)(conv7)
    #     conv8 = BatchNormalization()(conv8)
    #     conv8 = Activation('relu')(conv8)
    #     conv8 = Conv2D(int(512 * alpha), (1, 1), strides=(1, 1), padding='same', use_bias=False)(conv8)
    #     conv8 = BatchNormalization()(conv8)
    #     conv8 = Activation('relu')(conv8)
    #
    # conv9 = DepthwiseConv2D(int(512 * alpha), (3, 3), strides=(1, 1), padding='same', use_bias=False)(conv7)
    # conv9 = BatchNormalization()(conv9)
    # conv9 = Activation('relu')(conv9)
    # conv9 = Conv2D(int(512 * alpha), (1, 1), strides=(1, 1), padding='same', use_bias=False)(conv9)
    # conv9 = BatchNormalization()(conv9)
    # conv9 = Activation('relu')(conv9)
    #
    # conv10 = DepthwiseConv2D(int(512 * alpha), (3, 3), strides=(2, 2), padding='same', use_bias=False)(conv9)
    # conv10 = BatchNormalization()(conv10)
    # conv10 = Activation('relu')(conv10)
    # conv10 = Conv2D(int(1024 * alpha), (1, 1), strides=(1, 1), padding='same', use_bias=False)(conv10)
    # conv10 = BatchNormalization()(conv10)
    # conv10 = Activation('relu')(conv10)
    #
    # conv11 = DepthwiseConv2D(int(1024 * alpha), (3, 3), strides=(1, 1), padding='same', use_bias=False)(conv10)
    # conv11 = BatchNormalization()(conv11)
    # conv11 = Activation('relu')(conv11)
    # conv11 = Conv2D(int(1024 * alpha), (1, 1), strides=(1, 1), padding='same', use_bias=False)(conv11)
    # conv11 = BatchNormalization()(conv11)
    # conv11 = Activation('relu')(conv11)

    # conv10 = GlobalAveragePooling2D()(conv10)
    # out = Dense(classes, activation='softmax')(conv10)
    ...
    #
    # conv1 = Conv2D(32, (3, 3), strides=(2, 2), padding="same", kernel_initializer='he_normal', kernel_regularizer=l2(l2_reg), name='conv1')(x1)
    # conv1 = BatchNormalization(axis=3, momentum=0.99, name='bn1')(conv1) # Tensorflow uses filter format [filter_height, filter_width, in_channels, out_channels], hence axis = 3
    # conv1 = Activation('relu',name='relu1')(conv1)
    # pool1 = MaxPooling2D(pool_size=(2, 2), name='pool1')(conv1)
    #
    # conv2 = Conv2D(32, (3, 3), strides=(1, 1), padding="same", kernel_initializer='he_normal', kernel_regularizer=l2(l2_reg), name='conv2')(pool1)
    # conv2 = BatchNormalization(axis=3, momentum=0.99, name='bn2')(conv2)
    # conv2 = Activation('relu',name='relu2')(conv2)
    ...
    # conv3 = Activation('relu',name='relu3')(conv3)
    ...
    # conv4 = Activation('relu',name='relu4')(conv4)
    ...
    # conv5 = Activation('relu',name='relu5')(conv5)
    ...
    # conv6 = Activation('relu',name='relu6')(conv6)
    ...
    # conv7 = Activation('relu',name='relu7')(conv7)
    ...
    conv8=model.layers[-1].output
    conv9=model.layers[-7].output
    conv10=model.layers[-13].output
    conv11=model.layers[-20].output

    classes4 = Conv2D(n_boxes[0] * n_classes, (3, 3), strides=(1, 1), padding="same", kernel_initializer='he_normal', kernel_regularizer=l2(l2_reg), name='classes4')(conv8)
    classes5 = Conv2D(n_boxes[1] * n_classes, (3, 3), strides=(1, 1), padding="same", kernel_initializer='he_normal', kernel_regularizer=l2(l2_reg), name='classes5')(conv9)
    classes6 = Conv2D(n_boxes[2] * n_classes, (3, 3), strides=(1, 1), padding="same", kernel_initializer='he_normal', kernel_regularizer=l2(l2_reg), name='classes6')(conv10)
    classes7 = Conv2D(n_boxes[3] * n_classes, (3, 3), strides=(1, 1), padding="same", kernel_initializer='he_normal', kernel_regularizer=l2(l2_reg), name='classes7')(conv11)
    # Output shape of `boxes`: `(batch, height, width, n_boxes * 4)`
    boxes4 = Conv2D(n_boxes[0] * 4, (3, 3), strides=(1, 1), padding="same", kernel_initializer='he_normal', kernel_regularizer=l2(l2_reg), name='boxes4')(conv8)
    boxes5 = Conv2D(n_boxes[1] * 4, (3, 3), strides=(1, 1), padding="same", kernel_initializer='he_normal', kernel_regularizer=l2(l2_reg), name='boxes5')(conv9)
    boxes6 = Conv2D(n_boxes[2] * 4, (3, 3), strides=(1, 1), padding="same", kernel_initializer='he_normal', kernel_regularizer=l2(l2_reg), name='boxes6')(conv10)
    boxes7 = Conv2D(n_boxes[3] * 4, (3, 3), strides=(1, 1), padding="same", kernel_initializer='he_normal', kernel_regularizer=l2(l2_reg), name='boxes7')(conv11)
